...
# 获取绘图窗口
strawberry_bear_windows = gw.getWindowsWithTitle('草莓熊')

# 激活第一个窗口
strawberry_bear_window = strawberry_bear_windows[0]
strawberry_bear_window.activate()

# 等待3秒以确保绘图窗口已经激活
time.sleep(3)

# 截取绘图窗口的屏幕截图
screenshot = ImageGrab.grab(strawberry_bear_window.box)

# 保存截图为图像文件
screenshot.save("strawberry_bear.png")
